...
public class AccesWatching {
	...
	public void mainProgram() {
		...
		if(choice==1) {
			...
			Affichage.affich("interruption! svp il faut faire un choix");
			return;
		}
		...
		if(search(value,type,choice)){
			Affichage.affich("la valeur a ete trouvee");
		}
		else {
			Affichage.affich("la valeur n'a pas ete trouvee");
		}
	...
	public void sort(AscDescTri type,int method) {
		...
		default:{
			Affichage.affich("desole vous n'avez pas choisi une methode");
		}
